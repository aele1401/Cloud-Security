...
Only the Jump Box and ELK machines can accept connections from the internet. Access to this machine is only allowed from specific IP addresses that are whitelisted.
